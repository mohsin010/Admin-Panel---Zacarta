...
class CategoryPage extends React.Component {
    ...
    deleteCategory = (category, e) => {
        ...
        axios.post('https://api.zacarta.com/api/admin/category/delete', { category: category._id }, {
            headers: headers
        }).then(res => {
            if (res.status == 200) {
                this.setState({
                        ...
                        <FuseAnimate animation="transition.expandIn">
                            <Card className="w-full max-w-500" >
                                <CardContent className="flex flex-col items-center" >
                                    ...
                                    >
                                        <DialogTitle id="alert-dialog-title">{"Category Deleted"}</DialogTitle>
                                        <DialogContent>
                                    ...
                                    <div className={styles1.search}>
                                        <Autocomplete
                                            ...
                                            options={this.state.categories.map((option) => option.title)}
                                            renderInput={(params) => (
