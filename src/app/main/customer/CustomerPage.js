...
class Customer extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://api.zacarta.com/api/admin/buyer/', {
            headers: headers
        }).then(res => {
            debugger
            if (res.status == 200) {
                                                ...
                                                {this.state.suggestions.length == 0 ? this.state.customers.slice(this.state.page * this.state.rowsPerPage, this.state.page * this.state.rowsPerPage + this.state.rowsPerPage).map((customer, index) => {
                                                    ...
                                                    return (
                                                        <TableRow hover>
                                                            ...
                                                            <TableCell className={styles1.propic} ><img src={'https://api.zacarta.com/' + customer.avatar.value} /><div className={styles1.propicdiv}><div><div >{customer.name}</div></div></div></TableCell>
                                                            <TableCell>{customer.email}</TableCell>
                                                            <TableCell>{customer.mobile}</TableCell>
                                                            <TableCell>{customer.licanse}</TableCell>
